...
namespace EtasaDesktop.Billing
{
    public class BillingFormViewModel : ViewModelBase
    {
        ...
        public ObservableCollection<BillingDataSet.CompareDataOrderCepsaRow> OrdersMoreDatas { get; private set; }
        ...
        public BillingFormViewModel()
        {
            ...
            OrdersMoreDatas = new ObservableCollection<BillingDataSet.CompareDataOrderCepsaRow>();
        }
