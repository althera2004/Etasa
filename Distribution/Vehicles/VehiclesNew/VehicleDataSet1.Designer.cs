    ...
    public partial class VehicleDataSet1 : global::System.Data.DataSet {
        ...
        public partial class VehiclesSummariesRow : global::System.Data.DataRow {
            ...
            public float LastLocationLatitude {
                get {
                    try {
                        return ((float)(this[this.tableVehiclesSummaries.LastLocationLatitudeColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
            ...
            public float LastLocationLongitude {
                get {
                    try {
                        return ((float)(this[this.tableVehiclesSummaries.LastLocationLongitudeColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
SELECT Id, Code, Name, MaxTankVolume FROM Vehicles_Sizes WHERE (Id = @Id)";
    ...
    public partial class Vehicles_ObsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Vehicles_Obs] ([Id], [Observations]) VALUES (@Id, @Observation" +
                "s);\r\nSELECT Id, Observations FROM Vehicles_Obs WHERE (Id = @Id)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Vehicles_Obs] SET [Id] = @Id, [Observations] = @Observations WHERE " +
                "(([Id] = @Original_Id));\r\nSELECT Id, Observations FROM Vehicles_Obs WHERE (Id = " +
                "@Id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Id, Observations FROM dbo.Vehicles_Obs";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Id, Observations FROM dbo.Vehicles_Obs where id = @id_obs";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
    ...
    public partial class VehiclesSummariesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT        Vehicles.Id, Vehicles.Code, Vehicles.VIN, Vehicles.AxleCount, Vehicles.Weight, Vehicles.MaxWeight, Vehicles.TankVolume, ISNULL( Vehicles.StartDate,GETDATE()) as StartDate, ISNULL(Vehicles.FinalDate,GETDATE()) AS FinalDate, Vehicles.LastLocationLatitude, Vehicles.LastLocationLongitude, 
